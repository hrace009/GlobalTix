 ...
 *
 * @wordpress-plugin
 * Plugin Name:       GlobalTix
 * Plugin URI:        https://youtube.com/hrace009
 * Description:       GlobalTix API Testing for my job interview at skyshi.
 * Version:           1.0.0
 * Author:            Harris Marfel
 * Author URI:        https://youtube.com/hrace009
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       globaltix
...
register_activation_hook( __FILE__, 'activate_globaltix' );
register_deactivation_hook( __FILE__, 'deactivate_globaltix' );
 ...
 * @since    1.0.0
 */
function run_globaltix() {

	$plugin = new Globaltix();
	$plugin->run();
